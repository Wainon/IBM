...
# def get_answers_keyboards(user_id,test):
#     """Клавиатура для выбора или создания ответов в вопросе"""
#     answers = storage.get_answers(user_id, test)
#     buttons = [
#         [InlineKeyboardButton(text=q,callback_data=f"answer: {q}")]       for q in answers
#     ]
#     buttons.append([InlineKeyboardButton(text="Создать новый ответ", callback_data="create_answer")])
#     return InlineKeyboardMarkup(inline_keyboard=buttons)