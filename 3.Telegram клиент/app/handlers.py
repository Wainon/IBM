...
async def text_handler(message: Message):
    ...
    if state == "waiting_for_discipline_name":
        ...
        if test:
            ...
            await message.answer(
                f"Вопрос '{question_text}' добавлен в тест '{test}'. Теперь введите количество вариантов ответов."
            )
        ...
        if correct_answer in answers:
            ...
            await message.answer(
                "Этот ответ не найден среди предложенных! Пожалуйста, выберите правильный ответ через кнопки или введите его снова."
            )
